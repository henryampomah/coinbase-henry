...
const SignIn = () => {
  ...
  return (
    ...
    >
      ...
      {!cookieDismissed && (
        <div
          className="fixed bottom-0 left-0 right-0 px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4"
          style={{ backgroundColor: "#1c1d20", borderTop: "1px solid #2e2f33" }}
        >
          <p className="text-xs text-gray-300 leading-relaxed max-w-2xl">
            ...
            <Link to="/cookie-policy" className="text-blue-400 underline">
              Cookie Policy
            </Link>
            .
          </p>
